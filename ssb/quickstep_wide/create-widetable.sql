...
create index bw_12 on widetable (d_year) using bitweaving (type v);
create index bw_13 on widetable (d_yearmonthnum) using bitweaving (type v);
create index bw_14 on widetable (d_yearmonth) using bitweaving (type v);
create index bw_15 on widetable (d_weeknuminyear) using bitweaving (type v);
